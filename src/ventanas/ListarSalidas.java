 ...
 * @author mb
 */
public class ListarSalidas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_WallpaperHeader.setText("     Lista de Salidas");
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 70, 60, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarSalidas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarSalidas().setVisible(true);
            }
        });
    }
